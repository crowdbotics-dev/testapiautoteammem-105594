...
## Project Structure
    ...
    ├── testapiautoteammem_105594  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_105594`
...
2. Clone this repo and `cd testapiautoteammem_105594`
